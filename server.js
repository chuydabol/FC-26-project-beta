...
/* =========================
   UPCL & OTHER FIXTURES
========================= */
// Create fixture (Admin). Use cup ids: "UPCL" (league cup), "UPCL-CC" (Champions Cup), etc.
...
// Compute tables from final fixtures for a cupId (expects fixtures.cup === cupId and f.group set)
